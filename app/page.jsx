...
export default function Home() {
  ...
  useEffect(() => {
    fetch(
      ...
      .catch((error) =>
        console.error("Error fetching movies in Upcoming: ", error)
      );
  }, []);
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen">
      <main className="flex flex-col items-center  min-h-screen py-1">
        <h1 className="text-6xl font-bold m-4">Film Database</h1>
